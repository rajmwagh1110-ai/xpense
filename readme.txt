...
Key Features
------------
- Dashboard with summary cards, spending charts, budget progress, recent expenses, and a live hero KPI panel
- Weekly spending trend chart for quick trend analysis
...
- Track goals and review reports with deadline and pace guidance
- Responsive UI improvements for smaller screens
